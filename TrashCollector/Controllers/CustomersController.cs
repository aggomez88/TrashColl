...
namespace TrashCollector.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var customer = _context.Customer.Include(c => c.Address).Include(c => c.IdentityUser);
        ...
        public async Task<IActionResult> Create(Customer customer)
        {
            ...
            ViewData["AddressUserId"] = new SelectList(_context.Set<Address>(), "Id", "Id", customer.AddressUserId);
        ...
        public async Task<IActionResult> Edit(int id, Customer customer)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //customer.IdentityUserId = this.User.FindFirstValue(ClaimTypes.NameIdentifier);
                    var customerInDb = _context.Customer.Where(c => c.Id == customer.Id).Single();
